from intents.base import QueryDoc, Help
import teamin
...
class IntentQdocAbout(QueryDoc):
    NAME = 'QDOC_ABOUT'
    ...
    def Go(self):
        ...
        if hasattr(self, 'cond_p'):
            ...
            count, weburl = bdc.SpecifyKeywords(query, kw)
            self.intent.set_interval(0, 0, weburl)
        elif hasattr(self, 'cond_t'):
            count, weburl = bdc.SpecifyKeywords(query, kw, self.cond_t)
            self.intent.set_interval(0, 0, weburl)
    ...
    def patterns(self):
        return { 
            'a': '[D:kw_plz][D:user_q][D:user_doc][D:kw_sp][D:kw_inc][D:user_p][W:4-99][D:kw_rel][W:0-8]',
            'b': '[D:kw_plz][D:user_q][D:kw_inc][D:user_p][W:4-99][D:kw_rel][D:kw_de][D:user_doc]',
            'c': '[D:kw_plz][D:user_q][D:user_doc][D:kw_sp][D:kw_inc][W:8-99][D:kw_rel][D:kw_de][D:user_p][W:0-8]',
            'd': '[D:kw_plz][D:user_q][D:kw_inc][W:8-99][D:kw_rel][D:kw_de][D:user_p][D:kw_de][D:user_doc]',
            'e': '[D:kw_plz][D:user_q][D:kw_inc][W:0-2][D:user_t][W:0-8][D:user_t2][W:4-99][D:kw_rel][D:kw_de][D:user_doc]',
            'f': '[D:kw_plz][D:user_q][D:user_doc][D:kw_sp][D:kw_inc][W:0-2][D:user_t][W:0-8][D:user_t2][W:4-99][D:kw_rel][W:0-8]',
            'g': '[D:kw_plz][D:user_q][D:user_doc][D:kw_sp][D:kw_inc][D:user_t][W:4-99][D:kw_rel][W:0-8]',
            'h': '[D:kw_plz][D:user_q][D:kw_inc][D:user_t][W:4-99][D:kw_rel][D:kw_de][D:user_doc]',
            'i': '[D:kw_plz][D:user_q][D:kw_inc][W:8-99][D:kw_rel][D:kw_de][W:0-2][D:user_t][W:0-8][D:user_t2][D:kw_de][D:user_doc]',
            'j': '[D:kw_plz][D:user_q][D:user_doc][D:kw_sp][D:kw_inc][W:8-99][D:kw_rel][D:kw_de][W:0-2][D:user_t][W:0-8][D:user_t2][W:0-8]',
            'k': '[D:kw_plz][D:user_q][D:kw_inc][W:8-99][D:kw_rel][D:kw_de][D:user_t][D:kw_de][D:user_doc]',
            'l': '[D:kw_plz][D:user_q][D:user_doc][D:kw_sp][D:kw_inc][W:8-99][D:kw_rel][D:kw_de][D:user_t][W:0-8]',
        }
    ...
    def parseKeywords(self, oquery, pskey):
        ...
        if pskey in ['a', 'b']:
            ...
            s = self.slot_doc.offset + self.slot_doc.length + kw_sp[1] + kw_inc[1]
        elif pskey in ['d']:
